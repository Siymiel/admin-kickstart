        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-10 space-y-3">
              ...
              {/* Dashboard */}
              <li className={`px-3 py-3 rounded-xl flex justify-center mb-0.5 last:mb-0 ${pathname === '/overview' && 'bg-[#53237C]'}`}>
              ...
              {/* Orders */}
              <li className={`px-3 py-3 rounded-xl flex justify-center mb-0.5 last:mb-0 ${pathname === '/orders' && 'bg-[#53237C]'}`}>
                <NavLink end to="/orders" className={`block text-slate-800 hover:text-gray-500 truncate transition duration-150 ${pathname === '/orders' && '!text-slate-200'}`}>
                    <div className="w-36">
                        <div className="flex items-center">
                            <RxCalendar className={`shrink-0 w-7 h-6 text-slate-800 ${pathname === '/orders' && '!text-slate-200 !'}`}/>
              ...
              {/* Products */}
              <li className={`px-3 py-3 rounded-xl flex justify-center mb-0.5 last:mb-0 ${pathname === '/products' && 'bg-[#53237C]'}`}>
                <NavLink end to="/products" className={`block text-slate-800 hover:text-gray-500 truncate transition duration-150 ${pathname === '/products' && '!text-slate-200'}`}>
                    <div className="w-36">
                        <div className="flex items-center">
                            <CgProfile className={`shrink-0 w-7 h-6 text-slate-800 ${pathname === '/products' && '!text-slate-200 !'}`}/>
              ...
              {/* Users */}
              <li className={`px-3 py-3 rounded-xl flex justify-center mb-0.5 last:mb-0 ${pathname === '/users' && 'bg-[#53237C]'}`}>
                <NavLink end to="/users" className={`block text-slate-800 hover:text-gray-500 truncate transition duration-150 ${pathname === '/users' && '!text-slate-200'}`}>
                    <div className="w-36">
                        <div className="flex items-center">
                            <MdOutlineFavoriteBorder className={`shrink-0 w-7 h-6 text-slate-800 ${pathname === '/users' && '!text-slate-200 !'}`}/>
              ...
              {/* Transcations */}
              <li className={`px-3 py-3 rounded-xl flex justify-center mb-0.5 last:mb-0 ${pathname === '/transactions' && 'bg-[#53237C]'}`}>
